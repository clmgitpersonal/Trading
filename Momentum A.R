...
currency("USD")
#symbols <- c("SHY","XLY", "XLP", "XLE", "XLF", "XLV", "XLI", "XLK", "XLB", "XLU")
lowellAggGrowth <- c("FBGRX","FCNTX", "FARNX", "FIGFX", "FLPSX", "FGRTX", "FSPHX", "FSDIX","SHY")
aaiiMfPort <- c("MUB","CHTTX","FAGIX", "FOCPX", "FPX", "RSP", "RFV", "RZV", "FM","VNQ","SHY")
bondSymbols <- c("SHY","VBMFX","VFICX","VWITX","PTTAX","FHIFX","MUB","VWINX","GLD","SPY","EEM") 
# iSh short, vg total bnd mkit index, int inv grad, 
# vg int muni, pimco gross (janus gross = juctx),
# fido high income, iSh muni, wellesley

#symbols<- lowellAggGrowth
symbols <- aaiiMfPort
symbols <- bondSymbols
...
getSymbols(symbols, from = '2004-05-31', to = '2015-04-30', env = symEnv)
